...
if (isset($_POST['submit'])) {
    ...
    if ((empty($name)) && (empty($father)) && (empty($mother)) && (empty($bd)) && (empty($roll))) 
    {
        ...
        $query = "INSERT INTO applicants_bn (roll, name, father, mother, bd, pic, add_dt) VALUES ('$roll', '$name', '$father', '$mother', '$bd', '$pic_name', CURDATE())";
	...
	<div class="row">
		<div class="span12">
			<form enctype="multipart/form-data" class="form-horizontal"
				...
				<fieldset>
					<legend>Add Applicant Details (For Bangla Version)</legend>
