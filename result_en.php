...
<div class="container">
	<div class="row">
		<div class="span12">
					<p class="text-right"><a href="print_en.php">Print Result</a></p>
...
while ($row = mysqli_fetch_array($result)) {
    ...
    $result_pic = mysqli_query($link,
            "SELECT pic FROM applicants_en WHERE roll = '$roll' LIMIT 1");
    ...
    echo $i;
    echo "</td> <td>";
    echo "<img src='applicants_img_en/" . $img . "' width='60'>";
    echo "</td> <td>";
    echo $row['roll'];
    echo "</td> <td>";
    echo $row['name'];
